    ...
    scanQrcodeForWithdraw: async function (req, res) {
        try {
            ...
            if (httpResult) {
                ...
                return res.json(utils.response(0, 'Scan Qrcode For Withdraw failed, please try again.'));
            }
        } catch (error) {
    ...
    scanQrcodeForReturn: async function (req, res) {
        try {
            ...
            if (httpResult) {
                ...
                return res.json(utils.response(0, 'Scan Qrcode For Return failed, please try again.'));
            }
        } catch (error) {
    ...
    getTaskVehicleKeyStatus: async function(req, res) {
        try {
            ...
            if (keyStatus == 'out') {
                ...
                if (taskKeyOptRecordList && taskKeyOptRecordList.length > 0) {
